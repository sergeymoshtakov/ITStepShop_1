...
namespace ITStepShop.Controllers
{
    public class ProductController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["ProductUsages"] = new SelectList(_context.ProductUsage, "Id", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Create(Product product)
        {
            ...
            ViewData["ProductUsages"] = new SelectList(_context.ProductUsage, "Id", "Name", product.ProductUsageId);
            return View(product);
        }
